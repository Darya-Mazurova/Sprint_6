...
class OrderPageLocators:
    ...
    SELECT_METRO = (By.XPATH, "//div[@class = 'select-search__value']") #поле Станция метро

    # SELECT_METRO_STATION_1 = (By.XPATH) # 1-я станция метро из выпадающего списка
    ...
    TEXT_ORDER_CONFIRMED = (By.XPATH, "//div[contains(text(),'Заказ оформлен')]")  # заказ оформлен